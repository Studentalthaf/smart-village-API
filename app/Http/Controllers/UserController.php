...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'List Data User Berhasil', UserResource::collection($users), 200);
        } catch (\Exception $e) {
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true,'List Data User Berhasil',new PaginateResource($users, UserResource::class),200 );
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Detail Data User Berhasil Diambil', new UserResource($user), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
